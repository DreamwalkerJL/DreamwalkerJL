    ...
    return (
      <div>
        ...
        >
          ...
          <div className="relative bottom-96 flex items-center justify-center gap-60">
            <img className="relative z-20 h-36 w-36" src={ArrowL} ref={prevRef} />
            <img className="relative z-20 h-36 w-36" src={ArrowR} ref={nextRef} />
          </div>
        </FullScreen>
